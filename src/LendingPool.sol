...
contract LendingPool is ReentrancyGuard {
    ...
    function withdraw(uint256 shares) external nonReentrant {
        ...
        SafeERC20.safeTransfer(IERC20(debtToken), msg.sender, amount);
    ...
    function withdrawCollateral(uint256 amount) public {
        ...
        SafeERC20.safeTransfer(IERC20(collateralToken), msg.sender, amount);
    }
    ...
    function _isHealthy(address user) internal view {
        ...
        uint256 borrowed = (userBorrowShares[user] * totalBorrowAssets) /
            totalBorrowShares;
